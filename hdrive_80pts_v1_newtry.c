...
task LowGreenCube()
{
	while(true)
	{
		...
		resetMotorEncoder(Left);
		resetMotorEncoder(Right);
		setMotorTarget(Left, -650, 80);
		setMotorTarget(Right, -650, 80);
		waitUntilMotorStop(Left);
		waitUntilMotorStop(Right);
		wait1Msec(100);
...
*/
		...
		resetMotorEncoder(Left);
		resetMotorEncoder(Right);
		setMotorTarget(Left, 420, 50);
		setMotorTarget(Right, 420, 50);
		waitUntilMotorStop(Left);
		waitUntilMotorStop(Right);
		wait1Msec(10);
		...
		resetMotorEncoder(Left);
		resetMotorEncoder(Right);
		setMotorTarget(Left, -300, 50);
		setMotorTarget(Right, -300, 50);
		waitUntilMotorStop(Left);
		waitUntilMotorStop(Right);
		wait1Msec(10);
		...
		resetMotorEncoder(Left);
		resetMotorEncoder(Right);
		setMotorTarget(Left, 185, 30);
		setMotorTarget(Right, 185, 30);
		waitUntilMotorStop(Left);
		waitUntilMotorStop(Right);
		wait1Msec(10);
...
task redblue()
{
		while(true)
	{
		...
		resetMotorEncoder(Left);
		resetMotorEncoder(Right);
		setMotorTarget(Left,200, 40);
		setMotorTarget(Right,200, 40);
		waitUntilMotorStop(Left);
		waitUntilMotorStop(Right);
		wait1Msec(10);
		...
		resetMotorEncoder(Left);
		resetMotorEncoder(Right);
		setMotorTarget(Left, 300, 40);
		setMotorTarget(Right, 300, 40);
		waitUntilMotorStop(Left);
		waitUntilMotorStop(Right);
		wait1Msec(50);
		setMotorTarget(Left, 150, 50);
		setMotorTarget(Right, 150, 50);
		...
		resetMotorEncoder(Left);
		resetMotorEncoder(Right);
		setMotorTarget(Left,350, 50);
		setMotorTarget(Right,350, 50);
		waitUntilMotorStop(Left);
		waitUntilMotorStop(Right);
		wait1Msec(10);
